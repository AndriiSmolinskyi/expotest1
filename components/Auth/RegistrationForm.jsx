...
//           />
//           {touchedFields.confirmPassword && errors.confirmPassword && <Text style={styles.errorText}>{errors.confirmPassword}</Text>}
//           <TextInput
//             style={styles.input}
...
//             value={values.code}
//           />
//           {touchedFields.code && errors.code && <Text style={styles.errorText}>{errors.code}</Text>}
